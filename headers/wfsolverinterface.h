...
// This file includes the sources so that no additional linking
// is necessary to use the solver at the cost of onger compilationn times.
...
// The class Potential must provie the following methods:
...
// Include sources so that no linking to the libwfsolver.a is necessary.
#include "../lib/WFSolver/src/interpolator.cpp"
#include "../lib/WFSolver/src/wfsolver.cpp"
